...
<div class="logo-box dash-profile">
	<!-- <img src="https://seeklogo.com/images/B/bandeira-do-brasil-logo-B6E7F208FF-seeklogo.com.png" alt=""> -->
	<!-- <p>Apostas Online</p> -->
	<h3 data-remodal-target="modal">
		<div class="profile-box">
			<img src="https://image.dhgate.com/0x0s/f2-albu-g10-M00-18-39-rBVaWV0erq6AA-OrAASs3EYv1pk976.jpg/futurama-bender-esmalte-pino-bonito-rob-de.jpg" alt="" class="profile">
		</div>
		<p class="profile-name"><?php $nickname = get_user_meta( wp_get_current_user()->ID, 'nickname', true ); print_r($nickname)?></p>
		<p class="profile-bets">Apostas: 0</p>
		<p class="profile-wallet">Saldo: R$ 0,00</p>
	</h3>
